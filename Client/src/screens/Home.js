  ...
  if (isConnecting) {
    return (
      <div className="loading-container">
        ...
        <p>
          Trying to establish a connection to retrieve the latest food items!
        </p>
      </div>
    );
  }
    ...
    <div style={{ backgroundColor: "#2e2e35" }}>
      ...
      <div style={{ "margin-top": "6rem" }}>
        ...
        >
          <div className="carousel-inner" id="carousel">
            <div
              className="carousel-caption d-flex flex-column justify-content-end align-items-center"
                ...
                <div key={data._id}>
                  <div
                    ...
                    style={{
                      color: "#f2b315",
                      fontFamily: "Arial, sans-serif",
                      fontSize: "2rem", // Use relative units
                    }}
                  >
                    {data.CategoryName}
                  </div>
